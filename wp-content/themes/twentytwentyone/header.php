  ...
  <div class="container h-16 flex items-center  m-auto justify-between ">
    ...
    <div class="flex ">
      ...
      <div class="chalon md:block hidden">
            ...
            <div class="box   ">
                    <a class="cursor-pointer hover:text-gray-900  h-16 px-3 pb-[29px] pt-[17px]   bg-[#e7e7e7]" href="http://localhost/ChuyenDeCMS/">Home</a>
                </div>
            <div class="search  ml-5 ">
            <form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
            <div class="relative">
                <input type="text" class="w-60 h-9 p-2 rounded-xl border border-gray-300 " name="s" id="search" placeholder="Search..." value="<?php the_search_query(); ?>" />
    ...
    <ul class="navbar-navaa   space-x-4 contents ">
     ...
     <li class="item relative group">
         ...
         <ul class="dropdown-menu hidden absolute p-2  right-0 top-[20px] mt-2 space-y-1 bg-white border rounded-lg group-hover:block">
             <li><a class="dropdown-item" href="#">Action</a></li>
             <li><a class="dropdown-item" href="#">Another action</a></li>
             <li><a class="dropdown-item" href="#">Something else here</a></li>
             <li><hr class="dropdown-divider border-t border-gray-200"></li>
